...
#Changes made 4-26-24 to fix AUC issues:
...
#Creating train2 and test2
train2 <- train
test2 <- test

  # transforming predictor to binary in train2 and test2
...
#glm predicted ALL non-medalists??

#creating a binary version of lm_preds
lm_preds2 <- lm_preds
lm_preds2 <- as.factor(
...
auc(test$is_medalist, lasso_preds)
